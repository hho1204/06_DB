 ...
 *	 중복을 제거학도 한 번만 표시할 때 사용하는 구문(연산자)
 *
 * */
 ...
 *   -> 지정된 컬럼에 값이 존재 하지 않는 경우 / 존재 하는 경우
 *      (값의 유무를 따짐)
 * *****************************************
 * */
