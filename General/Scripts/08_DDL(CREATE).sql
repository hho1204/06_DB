 ...
 * 이름 : MEMBER_NAME  /     VARCHAR2(15BYTE) (한글 4글자까지)
...
INSERT INTO "MEMBER"
VALUES('MEM01','123AVC', '홍길동', '990102-1234567', CURRENT_DATE);
...
-- 가입일 -> SYSDATE를 활용
INSERT INTO "MEMBER"
VALUES('MEM02','QWER1234', '조혜연', '981204-1234567', CURRENT_DATE);

-- 가입일 -> DEFAULT 활용(테이블 생성 시 정의된 값이 반영됨)
INSERT INTO "MEMBER"
VALUES('MEM02','QWER1234', '조혜연', '981204-1234567', DEFAULT);

--> DEFAULT == 테이블 생성 시 지정한 DEFAULT 값(CURRNET_DATE)

-- 가입일 -> INSERT 시 미작성 하는 경우 -> DEAFULT 값이 반영됨
INSERT INTO "MEMBER"(MEMBER_ID, MEMBER_PW, MEMBER_NAME, MEMBER_SSN)
VALUES('MEM04', '1Q1W3E4R', '신짱구', '960604-1258978');
...
INSERT INTO USER_USED_UK
VALUES(1, NULL, 'pass01', '나갈동', '남', '010-1234-5678', 'hong123@kh.or.kr');

INSERT INTO USER_USED_UK
VALUES(1, NULL, 'pass01', '나달동', '남', '010-1234-5678', 'hong123@kh.or.kr');
...
VALUES (1, '호현11', 'QWER12','980402-1234567', '남', '010-1234-5678', '고양시 일산동구 식사동 위시티 자이2단지', 'N');
INSERT INTO USER_TEST 
VALUES (2, '혜연22', 'QWER34','981204-1234567', '여', '010-1284-5678', '고양시 일산동구 식사동 위시티 자이4단지', 'Y');
INSERT INTO USER_TEST 
VALUES (3, 'USER33', 'QWER56','990402-1234567', '남', '010-9734-5678', '고양시 일산동구 풍동 숲속마을 2단지', 'N');
INSERT INTO USER_TEST 
VALUES (4, 'USER44', 'QWER78','980602-1234567', '여', '010-1634-5678', '고양시 일산서구 마두동', 'Y');
INSERT INTO USER_TEST 
VALUES (5, 'USER55', 'QWER90','980422-1234567', '남', '010-1774-5678', '고양시 일산서구 대화동', 'N');
